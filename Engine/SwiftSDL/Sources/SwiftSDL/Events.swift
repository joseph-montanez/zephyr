extension SDL_Event {
    public var eventType: SDL_EventType {
            ...
            return SDL_EventType(Int32(type))  // type is Int32 on Windows
        #else
...
public struct SDL_MouseWheelDirection: RawRepresentable, Sendable, Equatable {
    ...
    // SDL_MOUSEWHEEL_NORMAL is 0
    public static let normal = SDL_MouseWheelDirection(rawValue: 0)

    // SDL_MOUSEWHEEL_FLIPPED is 1
    public static let flipped = SDL_MouseWheelDirection(rawValue: 1)
}
