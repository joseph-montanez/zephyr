...
// When compiled as C (not C++), define CIMGUI_DEFINE_ENUMS_AND_STRUCTS
// so that cimgui.h provides its own enum/struct definitions.
// In C++ compilation (cimgui.cpp), imgui.h already provides all types,
// so this must NOT be defined (hence the #undef in cimgui.cpp).
#ifndef __cplusplus
