...
// cimgui.h is designed so that CIMGUI_DEFINE_ENUMS_AND_STRUCTS should only
// be defined when imgui.h is NOT already included (i.e. C/Swift interop).
// In C++ compilation, imgui.h provides all types; cimgui.h must not redefine them.
