...
/// Build font atlas
// Note: GetTexDataAsRGBA32 was removed in imgui 1.92.x.
// Font atlas texture is now managed internally via ImFontAtlas::GetTexRef().
var pixels: UnsafeMutablePointer<UInt8>? = nil
var width: Int32 = 0
var height: Int32 = 0
var bytesPerPixel: Int32 = 0
// io.Fonts->GetTexDataAsRGBA32(&tex_pixels, &tex_w, &tex_h); (REMOVED in 1.92.x)
