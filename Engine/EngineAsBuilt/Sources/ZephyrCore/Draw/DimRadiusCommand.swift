// Sources/ZephyrCore/Draw/DimRadiusCommand.swift
import Foundation
import CSDL3
import ImGui
import SwiftSDL
...
@MainActor
public final class DimRadiusCommand: FeatureCommand {
    ...
    public func renderOverlay(cam: CameraTransform, engine: PhrostEngine) {
        ...
        case .pickingTextLocation:
            ...
            let p1 = EngineCameraManager.worldToScreen(worldX: arcPoint.x, worldY: arcPoint.y, cam: cam)
            let p2 = EngineCameraManager.worldToScreen(worldX: textLoc.x, worldY: textLoc.y, cam: cam)
    ...
    private func commitDimension(center: Vector3, radius: Double, textLoc: Vector3, engine: PhrostEngine, processor: CADCommandProcessor) {
        ...
        // Leader from arc point to text location
