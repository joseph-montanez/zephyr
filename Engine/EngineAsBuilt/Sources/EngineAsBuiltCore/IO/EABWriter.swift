...
// MARK: - EABWriter
//
// Serializes an EngineAsBuilt CAD document to the EAB binary format.
...
/// Serializes a `CADDocument` to the EngineAsBuilt Binary (.eab) file format.
///
/// Usage:
/// ```swift
